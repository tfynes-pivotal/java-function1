...
k8s_custom_deploy(
    ...
    apply_cmd="tanzu apps workload apply -f config/workload.yaml --update-strategy replace --debug --live-update" +
        ...
        " && kubectl get workload java-function1 --namespace " + NAMESPACE + " -o yaml",
...
k8s_resource('java-function1', port_forwards=["8080:8080"],
    extra_pod_selectors=[{'carto.run/workload-name': 'java-function1', 'app.kubernetes.io/component': 'run'}])
