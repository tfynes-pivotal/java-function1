...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=tfynes-pivotal&repo=java-function1",
  "buildType" : "maven",
  "includeTap" : true,
  "interfaceType" : "http",
  "projectName" : "java-function1"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [java-function->java-function1]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=tfynes-pivotal&repo=java-function1'
